...
<%	
	...
	if Session("memID") = "3" then
		loggedIn = "yes"
		temp = request.QueryString("id")
		if (temp = "new") or (temp = "") then temp = 1
		Session("specialsID") = temp
		sSQL = "SELECT * FROM specials"
		sSQL = sSQL & " WHERE ID = " & cint(Session("specialsID"))
	else
	...
	IF loggedIn = "never" then
		...
		if oRs.EOF and oRs.BOF then
			...
			if (addnew = "new") or (addnew = "") then
				...
				oRs.MoveFirst
				specialsID = oRs("ID")
				session("specialsID") = oRs("ID")
				promotext = oRs("description")
				specialstitle = oRs("title")
				specialsurl = oRs("url")
				specialsImage = oRs("image")
				specialsstart = oRs("startdate")
				specialsend = oRs("endDate")
				specialsitem = oRs("item")
				if isnull(specialsitem) then specialsitem = 0
			end if
  			oRs.close()
  			Set oRs = Nothing
...
<div id="content">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="498" valign="top">
      <tr>
        ...
        <%if loggedIn = "yes" then %>
			...
			<tr bgcolor="#ffffff">
				...
				<td colspan="2" class="BlueText" width="408" valign="top" align="center">
					...
					<b>Special Offers</b><br><br><br>
					<font size="2"><b><i>Offers List</i></b></font>
				</td>
			</tr>
			</table>
			</table>
		...
		sql = "select * from specials Order BY item;"
		rs.Open SQL, objConn, 1, 3
%>
<a href="specialsadmin.asp?id=new">Add New</a><br><br>
<table cellspacing="3" width="440" Border="0" ID="Table1">
	<tr>
		<td align="left"><font size="2">Title</td>
		<td align="left"><font size="2">Start</td>
		<td align="left" nowrap><font size="2">End</td>
		<td align="left" nowrap><font size="2">Item</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="left"><font size="2"><a href="specialsadmin.asp?id=<%=rs("id")%>"><%= rs("title") %></a></td>
		<td align="left"><font size="2"><%=rs("startdate")%></td>
		<td align="left"><font size="2"><%=rs("enddate")%></td>
	...
	Loop    
	  ...
	  %>
		...
		<form name="updateForm" action="savespecialsDetails.asp?id=<%=request.QueryString("id")%>" method="post">
		...
		<table width="440" cellpadding="0" cellspacing="0">
			...
			<tr bgcolor="#ffcc99">
				...
				<td class="LargeBlack" width="150" valign="top" align="left">
					<b>Item: <font color="#FFFFFF" size="2"></font></b>
				</td>
				<td class="LargeBlack" width="310" valign="top" align="left">
					<SELECT tabIndex=1 name=specialsitem ID="Select1">
					<%
					for n = 1 to 50
						if cint(specialsitem) = n then
						%>
						<OPTION value=<%=specialsitem%> selected><%=specialsitem%></OPTION>
						<%
						else
						%>
			...
			<tr bgcolor="#ffcc99">
				...
				<td class="LargeBlack" width="150" valign="top" align="left">
					<b>Title: <font color="#FFFFFF" size="2"></font></b>
				</td>
				<td class="LargeBlack" width="310" valign="top" align="left">
					<input type="text" name="specialstitle" size="30" value="<%=specialstitle%>">
				</td>
			</tr>
			<tr bgcolor="#ffcc99">
				...
				<td class="LargeBlack" width="150" valign="top" align="left">
					<b>URL: <font color="#FFFFFF" size="2"></font></b>
				</td>
				<td class="LargeBlack" width="310" valign="top" align="left">
					<input type="text" name="specialsurl" size="30" value="<%=specialsurl%>">
				</td>
			</tr>
			<tr bgcolor="#ffcc99">
				<td class="WhiteText" width="15" valign="top" align="left">
				...
				<td class="LargeBlack" width="150" valign="top" align="left">
					<b>Image: <font color="#FFFFFF" size="2"></font></b>
				</td>
				<td class="LargeBlack" width="310" valign="top" align="left">
					<input type="text" name="specialsImage" size="30" value="<%=specialsImage%>">
				</td>
			</tr>
			<tr bgcolor="#ffcc99">
				<td class="WhiteText" width="15" valign="top" align="left">
				...
				<td class="LargeBlack" width="150" valign="top" align="left">
					<b>Start Date: (dd/mm/yy)<font color="#FFFFFF" size="2"></font></b>
				</td>
				<td class="LargeBlack" width="310" valign="top" align="left">
					<input type="text" name="specialsstart" size="30" value="<%=specialsstart%>">
				</td>
			</tr>
			<tr bgcolor="#ffcc99">
				<td class="WhiteText" width="15" valign="top" align="left">
				...
				<td class="LargeBlack" width="150" valign="top" align="left">
					<b>End Date: (dd/mm/yy)<font color="#FFFFFF" size="2"></font></b>
				</td>
				<td class="LargeBlack" width="310" valign="top" align="left">
					<input type="text" name="specialsend" size="30" value="<%=specialsend%>">
				</td>
			</tr>
			<tr bgcolor="#ffcc99">
				<td class="WhiteText" width="15" valign="top" align="left">
...
<IMG SRC="js/sep.gif" WIDTH=2 HEIGHT=22 ALT="" BORDER="0">
  ...
  <%		else
	...
	%>				
					...
					<form name="LoginForm" action="specialsadmin.asp" method="post">
					<table width="360" cellpadding="0" cellspacing="0">
						<tr bgcolor="#0099CC">
							<td class="WhiteText" width="8" valign="top" align="left">
								<img src="images/pix.gif" width="8" height="1">
